...
-- FASE 5: llama al SP           -> crea/actualiza las 3 vistas de hechos + 12 vistas de dimensiones
...
BEGIN
    ...
    RETURN 'SP_DEPLOY_OPTIMIZED OK: 3 vistas de hechos + 12 vistas de dimensiones creadas/actualizadas.';
END;
$$;
